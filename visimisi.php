...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="index.php">STMIK Akakom | Visi Misi</a>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item active" href="visimisi.php">Visi dan Misi</a>
  ...
  <div class="text-center" style="margin-top:40px; margin-bottom:20px">
    <img src="img/gedung.jpg" class="img-fluid" alt="Responsive image">
  </div>
