...
<head>
	<title>STMIK Akakom | Arsip Umum</title>
	...
	<div class="col-sm-6">
		<div class="card" style="padding:1em">
			<div class="card-block">
				...
				<p>admin, Sel, 4-Agt-2015 08:27:35</p>
				<a href="https://www.akakom.ac.id/site/artikel/193/kalender-akademik" class="btn btn-primary">Buka</a>
			</div>
		</div>
	</div>
	<div class="col-sm-6">
		<div class="card" style="padding:1em">
			<div class="card-block">
				<h3 class="card-title">Blog STMIK AKAKOM Yogyakarta</h3>
				<p>Jum, 13-Sep-2013 08:05:25</p>
				<a href="https://www.akakom.ac.id/site/artikel/193/kalender-akademik" class="btn btn-primary">Buka</a></a>
			</div>
		</div>
	</div>
</div>
